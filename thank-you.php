    ...
    <div class="main-wrapper page-login">
        <div class="container content-wrapper loginpage-sec">
            <div class="row" id="login-section">
                <div class="col-xs-12 col-sm-12 col-md-12" id="left-content">
                    <h1><span class="heading-highlight">Thank you for completing the registration form. Your submission has been received and we appreciate your interest in our organization. </h1>
                    <h3>If you have any questions or concerns, please don't hesitate to contact us. Thank you again for your time and consideration.</h3>
